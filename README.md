# 👨‍💻 Víctor Borbor - Developer Portfolio
...
### [SmartTicTacToe](https://github.com/vicbguti-espol/SmartTicTacToe)  
Unbeatable Tic-Tac-Toe game using decision trees.  
- **Technologies**: Java, JavaFX, data structures.

### [PhoneApp](https://github.com/vicbguti-espol/PhoneApp)  
Contact management app with a clean JavaFX UI.  
- **Technologies**: Java, JavaFX.

### [Proyecto_PreTAWS_G4](https://github.com/vicbguti-espol/Proyecto_PreTAWS_G4)  
...
### [Scoring-by-Image](https://github.com/vicbguti-espol/Scoring-by-Image)  
...
### [tweets_by_keywords](https://github.com/vicbguti-espol/tweets_by_keywords)  
...
### [POO-P3-G07](https://github.com/vicbguti-espol/POO-P3-G07)  
"Who Wants to Be a Millionaire?" game with academic questions for university-level classroom dynamics.  
- **Technologies**: Java, JavaFX.

### [CKKS Encryption of Goods Costs](https://github.com/kesameji/ProyectoAlgebra)  
...
### [GoFundMeDB](https://github.com/vicbguti-espol/GoFundMeDB)  
Database design and implementation for a crowdfunding platform replica.  
- **Technologies**: MySQL, relational modeling.

### [real-tntrun](https://github.com/vicbguti-espol/real-tntrun)  
...
- **Python** – for automation, scraping, data analysis, AI, and web services.
- **Java** – for object-oriented development and graphical user interfaces.
- **SQL** – for relational database design and queries.

### Tools and Frameworks
- **JavaFX** – for building desktop GUI applications in Java.
- **Langchain & Chainlit** – for intelligent chatbot development.
- **Selenium** – for automating browser-based academic processes.
- **OpenAI API** – for using generative AI to build intelligent recommendation tools.
- **OpenCV** – for real-time image processing and vision-based interaction.
...
- **GitHub Profile**: [https://github.com/vicbguti-espol](https://github.com/vicbguti-espol)
- **Portfolio Site (GitHub Pages)**: [https://vicbguti-espol.github.io](https://vicbguti-espol.github.io)
